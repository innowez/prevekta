...
const ContactForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const scriptURL =
      "https://script.google.com/macros/s/AKfycbyBguWX_BA8I92qucOt_hCtJTVYparl4vqnPkfMega3haYn8D8JYFs6Qnoa1_A8YicV/exec";
  ...
  return (
    <div className="flex flex-col lg:flex-row items-start px-4 py-12 md:py-20 lg:pt-40 mx-auto max-w-[1360px] gap-10 md:gap-20 relative">
      ...
      >
        ...
        <div className="flex flex-col md:flex-row gap-4 w-full">
          <div className="w-full md:w-1/2 border-b border-[rgba(19,45,71,0.2)] pb-2">
            <input
              ...
              placeholder="Name"
              required
              className="w-full text-primary text-base md:text-[18px] leading-[23px] font-[Duplet] font-semibold bg-transparent outline-none placeholder:text-primary placeholder:font-normal"
            />
          </div>
          <div className="w-full md:w-1/2 border-b border-[rgba(19,45,71,0.2)] pb-2">
            <input
        ...
        {/* Contact Fields */}
        <div className="pb-2 border-b border-[rgba(19,45,71,0.2)] w-full">
          {/* <div className="w-full md:w-1/2 border-b border-[rgba(19,45,71,0.2)] pb-2">
            <input
              name="email"
              // name="Email"
          ...
          <select name="quary" className="w-full text-base text-primary md:text-[18px] leading-[23px] font-[Duplet] bg-transparent outline-none" >
