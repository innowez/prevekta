...
const ContactSection = () => {
  return (
    <div className="flex flex-col md:flex-row items-start px-4 py-12 md:py-20 md:pt-40 mx-auto max-w-[1360px] gap-10 md:gap-20 relative">
      ...
      {/* Form Section */}
      <form className="w-full md:w-1/2 space-y-6 md:space-y-10">
        {/* Name Fields */}
